...
export default {
    ...
    mounted() {
        ...
        anno.loadAnnotations('https://api-dev-4.simplex-med.com/get-lab-document-annotation');
  ...
  axios.post('https://api-dev-4.simplex-med.com/set-lab-document-annotation').then((response) => {
    console.log('Stored.');
  });
});
    ...
    console.log('Stored.');
        ...
        // open initial file
        this.viewer.open(`${this.$route.params.name}.dzi`)
